<%@ WebHandler Language="C#" Class="RequestFromRequestAutoCopyValuesHandler" %>
...
/// <summary>
/// Create Request from Request Plugin Auto Copy Values Handler
/// </summary>
public class RequestFromRequestAutoCopyValuesHandler : PluginHandler
{
...
, Usr, Pwd, MsgKey));
    ...
    private class Rule
    {
        public int fromReqTypeId { get; set; }
        public int[] toReqTypeIds { get; set; }
        public int[] copyFieldIds { get; set; }
    }
